...
<div class="container">
    <div class="content">
       ...
       <form method="post">
        <center>
        <table>
            <tr><td colspan="2"><h4>MASUK (BIDANG PENYELENGGARA)</h4></td></tr>
            <tr>
            <td><img src="<?= base_url(); ?>assets/images/Logo-Jawa+Tengah.png" width="128" height="142" alt=""></td>
            <td>
    ...
    <a style="float: right" href="<?= site_url() ?>index.php/kabkota">Masuk sebagai kontributor</a>
</div>
<br>
	<!-- Add jQuery library -->
